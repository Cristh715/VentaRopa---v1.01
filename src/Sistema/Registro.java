...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelRound5 = new Sistema.PanelRound();
        ...
        btnre.setBackground(new java.awt.Color(0, 119, 182));
        ...
        panelRound5.setBackground(new java.awt.Color(226, 221, 221));
        panelRound5.setForeground(new java.awt.Color(225, 224, 224));
        ...
        lbltitle.setFont(new java.awt.Font("Dubai Medium", 1, 21)); // NOI18N
        lbltitle.setForeground(new java.awt.Color(0, 119, 182));
        lbltitle.setText("Credenciales");
        panelRound5.add(lbltitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 130, 50));

        txtcon.setBackground(new java.awt.Color(226, 221, 221));
        txtcon.setFont(new java.awt.Font("Dubai", 0, 16)); // NOI18N
        txtcon.setForeground(new java.awt.Color(0, 0, 0));
        txtcon.setBorder(null);
        panelRound5.add(txtcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 190, 20));

        txtc.setBackground(new java.awt.Color(226, 221, 221));
        txtc.setFont(new java.awt.Font("Dubai", 0, 16)); // NOI18N
        txtc.setForeground(new java.awt.Color(0, 0, 0));
        txtc.setBorder(null);
        txtc.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        panelRound5.add(txtc, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 190, 20));

        lblc.setFont(new java.awt.Font("Dubai Medium", 0, 16)); // NOI18N
        lblc.setForeground(new java.awt.Color(0, 0, 0));
        lblc.setText("Contraseña");
        panelRound5.add(lblc, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 90, 20));

        lblu.setFont(new java.awt.Font("Dubai Medium", 0, 16)); // NOI18N
        lblu.setForeground(new java.awt.Color(0, 0, 0));
        lblu.setText("Correo");
        panelRound5.add(lblu, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 70, 20));

        fondo.add(panelRound5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 290, 380, 160));
    ...
    private void btnreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreMouseClicked
        ...
        if (nombres.equals("Nombre") || apellidos.equals("Apellidos") || contraseña.equals("DNI")){
            JOptionPane.showMessageDialog(null, "Rellene todo los campos.","Error de registro", JOptionPane.ERROR_MESSAGE);
        }
        else{
        try{
    ...
    private void dnie(){
        ...
        dni.setBackground(new Color(0,119,182));
    ...
    private void apellidoe (){
        ...
        apellido.setBackground(new Color(0,119,182));
    ...
    private void nombree(){
        ImageIcon imagen1 = new ImageIcon(this.getClass().getResource("/imagenes/usuario2.png"));
            nombre.setBackground(new Color(0,119,182));
    ...
    private Sistema.PanelRound panelRound5;
